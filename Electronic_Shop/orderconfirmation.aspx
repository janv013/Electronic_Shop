<%@ Page Title="" Language="C#" MasterPageFile="~/userside.Master" AutoEventWireup="true" CodeBehind="orderconfirmation.aspx.cs" Inherits="Electronic_Shop.orderconfirmation" %>
...
<asp:Content ID="Content2" runat="server" contentplaceholderid="ContentPlaceHolder2">
    ...
    <div class="container mt-5">
        <div class="alert alert-success">
            ...
            <p>Order ID: <asp:Label ID="lblOrderID" runat="server" CssClass="fw-bold"></asp:Label></p>
            <a href="dashboard.aspx" class="btn btn-primary">Back to Home</a>
        </div>
    </div>
