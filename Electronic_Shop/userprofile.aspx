<%@ Page Title="" Language="C#" MasterPageFile="~/userside.Master" AutoEventWireup="true" CodeBehind="userprofile.aspx.cs" Inherits="Electronic_Shop.userprofile" %>
            ...
            <div class="container">
                <div class="row">
					...
					<div class="col-md-12 col-lg-3 mb-5 mb-lg-0">
                        ...
                        <p>
                            <a href="shop.html" class="btn">Explore</a></p>
                    </div>
					<!-- End Column 1 -->
        ...
        <div class="card-body">
            <form>
                <div class="mb-3">
                    ...
                    <asp:TextBox ID="txtnm" class="form-control" runat="server" placeholder="Enter Full Name"></asp:TextBox>
                </div>
                <div class="mb-3">
                    <label class="form-label">Mobile No</label>
                    <asp:TextBox ID="txtmobileno" class="form-control" runat="server" placeholder="Enter Mobile Number"></asp:TextBox>
                </div>
                <div class="mb-3">
                    <label class="form-label">Email</label>
                    <asp:TextBox ID="txtemail" class="form-control" runat="server" placeholder="Enter Email"></asp:TextBox>
                </div>
                <asp:Button ID="Button1" class="btn btn-primary" runat="server" Text="Update Profile" OnClick="Button1_Click" />
            </form>
        </div>
    </div>
</div>
